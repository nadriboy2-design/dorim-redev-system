...
const STAGE_GUIDE: Record<string, {
  ...
  STAGE_1_PRELIMINARY: {
    subStages: [
      "① 사전검토 신청 (동의율 40% 필요) — 영등포구 접수",
      "② 정비계획 입안 제안 ← 현재 진행중 ✓",
      "③ 계획검토 (영등포구)",
      "④ 주민설명회·주민공람 (영등포구 주관)",
      "⑤ 구의회 의견청취 (영등포구의회)",
      "⑥ 정비계획 결정 요청 (영등포구 → 서울시)",
      "⑦ 감정평가 (국토계획법 제46조11항 — 시 관련 위원회 심의 이전)",
      "⑧ 市 도시계획위원회 심의 (서울시)",
      "⑨ 정비계획 결정·고시 【인허가권자: 서울시】",
      "⑩ 건축심의 등 인허가 절차 【건축심의: 서울시 담당】",
      "⑪ 준공인가",
    ],
    cautions: [
      "【인허가권자 구분】 정비계획 결정·고시 → 서울시 / 추진위·조합·사업시행·관리처분 → 영등포구청장",
      "【건축심의】 서울시 소관 (도시건축공동위원회)",
  ...
  STAGE_2_COMMITTEE: {
    subStages: [
      ...
      "추진위원장 및 위원 선출 (창립총회)",
      "추진위원회 운영규정 작성",
      "추진위원회 승인 신청 【인허가권자: 영등포구청장】 (동의율 50% 필요)",
      "정비사업관리업자 선정",
      "설계자 선정",
      "변호사·회계사 선정",
      "추진위원회 운영 개시",
  ...
  STAGE_3_ASSOCIATION: {
    subStages: [
      ...
      "조합 설립 인가 신청 【인허가권자: 영등포구청장】",
      "법인 등기",
      "외부회계감사",
      "건축심의 신청 【담당: 서울시 도시건축공동위원회】",
      "교통영향평가",
      "조합설립 인가 고시",
      "조합원 명부 확정 및 통보",
    ],
    cautions: [
      "【인허가권자】 조합설립인가 → 영등포구청장 권한",
      "【건축심의】 서울시 도시건축공동위원회 소관 (시공사 선정 전 진행)",
  ...
  STAGE_4_BUSINESS: {
    subStages: [
      "시공자 선정 【인허가권자: 영등포구청장 — 조합설립인가 이후】",
      "건축 기본설계 완료",
      "환경영향·교통영향 평가",
      "건축심의 【담당: 서울시 도시건축공동위원회】",
      "사업시행계획 인가 신청 【인허가권자: 영등포구청장】",
      "외부회계감사",
      "명도소송 (필요 시)",
      "사업시행 인가 고시",
    ],
    cautions: [
      "【인허가권자】 사업시행인가 → 영등포구청장 권한",
      "【건축심의】 서울시 담당 — 평균 3~6개월 소요",
      "【시공자 선정】 반드시 조합설립인가 이후 선정 (하드락 B: 이전 시도 자동 차단)",
  ...
  STAGE_6_DISPOSAL: {
    subStages: [
      ...
      "한국부동산원 타당성 검토",
      "총회 의결 (출석 2/3 이상)",
      "관리처분계획 인가 신청 【인허가권자: 영등포구청장】",
      "국·공유지 매입",
      "관리처분 고시",
    ],
    cautions: [
      "【인허가권자】 관리처분계획 인가 → 영등포구청장 권한",
